...
/***/ 354:
/*!***************************************************************************!*\
  !*** D:/Program_work/tongChen_App/main.js?{"page":"pages%2Fchat%2Fchat"} ***!
  \***************************************************************************/
...
var _chat = _interopRequireDefault(__webpack_require__(/*! ./pages/chat/chat.vue */ 355));
// @ts-ignore
...
/***/ 355:
/*!********************************************************!*\
  !*** D:/Program_work/tongChen_App/pages/chat/chat.vue ***!
  \********************************************************/
/*! no static exports found */
...
/* harmony import */ var _chat_vue_vue_type_template_id_bf16e7f4_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chat.vue?vue&type=template&id=bf16e7f4&scoped=true& */ 356);
...
/* harmony import */ var _chat_vue_vue_type_style_index_0_id_bf16e7f4_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chat.vue?vue&type=style&index=0&id=bf16e7f4&scoped=true&lang=scss& */ 360);
...
/***/ 356:
/*!***************************************************************************************************!*\
  !*** D:/Program_work/tongChen_App/pages/chat/chat.vue?vue&type=template&id=bf16e7f4&scoped=true& ***!
  \***************************************************************************************************/
...
/***/ 357:
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--17-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/Program_work/tongChen_App/pages/chat/chat.vue?vue&type=template&id=bf16e7f4&scoped=true& ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function () {
  ...
  var l0 = _vm.__map(_vm.messages, function (message, __i0__) {
    ...
    var m0 = _vm.formatTime(message.time)
    return {
      $orig: $orig,
      m0: m0,
    }
...
/***/ 358:
/*!*********************************************************************************!*\
  !*** D:/Program_work/tongChen_App/pages/chat/chat.vue?vue&type=script&lang=js& ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 359:
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--13-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/Program_work/tongChen_App/pages/chat/chat.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  ...
  methods: {
    cleanDuplicateConversations: function cleanDuplicateConversations() {
      var listKey = 'chat_conversations';
      var saved = uni.getStorageSync(listKey);
      if (!saved) return;
      try {
        var conversations = JSON.parse(saved);
        // 用 Map 去重，保留最后一条（最新的）
        var uniqueMap = new Map();
        conversations.forEach(function (c) {
          uniqueMap.set(String(c.userid), c);
        });
        var cleaned = Array.from(uniqueMap.values());
    ...
    loadMessages: function loadMessages() {
      var key = "chat_".concat(this.userID);
      var saved = uni.getStorageSync(key);
      if (saved) {
    ...
    updateConversationList: function updateConversationList() {
      ...
      var listKey = 'chat_conversations';
      var saved = uni.getStorageSync(listKey);
      var conversations = saved ? JSON.parse(saved) : [];
      var myUserID = uni.getStorageSync('userid') || '';
      ...
      conversations = conversations.filter(function (c) {
        return String(c.userid) !== String(_this.userID);
      });
      ...
      console.log('会话列表更新:', {
        ...
        records: conversations.map(function (c) {
          return {
            userid: c.userid,
            title: c.title
          };
    ...
    addWelcomeMessage: function addWelcomeMessage() {
      if (this.messages.length === 0) {
        this.messages.push({
          id: Date.now(),
          content: "\u4F60\u597D\uFF01\u6211\u662F".concat(this.userName, "\uFF0C\u5F88\u9AD8\u5174\u8BA4\u8BC6\u4F60~"),
          time: Date.now(),
          isSelf: false,
    ...
    sendMessage: function sendMessage() {
      ...
      this.scrollToBottom();
      setTimeout(function () {
        _this2.mockReply(text);
      }, 1000);
    },
    mockReply: function mockReply(text) {
      var replies = ['收到啦~', '嗯嗯，有道理！', '哈哈哈', '真的假的？', '我也是这么想的', '有空一起玩呀', '在忙，稍后回复你', '嗯嗯，了解了'];
    ...
    scrollToBottom: function scrollToBottom() {
      ...
      this.$nextTick(function () {
        if (_this3.messages.length > 0) {
          var lastMsg = _this3.messages[_this3.messages.length - 1];
          _this3.scrollToId = 'msg-' + lastMsg.id;
        }
      });
    },
...
/***/ 360:
/*!******************************************************************************************************************!*\
  !*** D:/Program_work/tongChen_App/pages/chat/chat.vue?vue&type=style&index=0&id=bf16e7f4&scoped=true&lang=scss& ***!
  \******************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 361:
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--8-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--8-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-2!./node_modules/postcss-loader/src??ref--8-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/sass-loader/dist/cjs.js??ref--8-oneOf-1-4!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-5!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/Program_work/tongChen_App/pages/chat/chat.vue?vue&type=style&index=0&id=bf16e7f4&scoped=true&lang=scss& ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
