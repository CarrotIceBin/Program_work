		...
		computed: {
			...
			timeStyle() {
				...
				return {
					...
					width: `${fontSize * 22 / 14}rpx`, // 按字体大小为 14px 时的比例缩放
 					lineHeight: `${fontSize * 20 / 14}rpx`,
					borderRadius: `${fontSize * 3 / 14}rpx`,
				}
			},
			splitorStyle() {
				...
				return {
					color: splitorColor,
					fontSize: `${fontSize * 12 / 14}rpx`,
					margin: backgroundColor ? `${fontSize * 4 / 14}rpx` : ''
				}
			}
		},
		watch: {
